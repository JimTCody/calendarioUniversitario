    ...
    Imgur.prototype = {
        ...
        createDragZone: function () {
            var p1, p2, input;
                ...
                p1 = this.createEls('p', {}, 'Arrastra y suelta tu imagen aqui');
                p2 = this.createEls('p', {}, 'O selecciona tu imagen');
            input = this.createEls('input', {type: 'file', multiple: 'multiple', className: 'input', id:'foto', accept: 'image/*'});
